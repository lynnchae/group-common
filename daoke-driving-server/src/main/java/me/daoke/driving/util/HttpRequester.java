...
public class HttpRequester {
	...
	private Logger log = LoggerFactory.getLogger(HttpRequester.class);
	
	private String defaultContentEncoding;

    private String contentType ;

    public static final String BOUNDARY = "----abc\r\n";
	...
	private HttpRespons send(String urlString, String method,
		...
		if (method.equalsIgnoreCase("GET") && parameters != null) {
			...
			urlString += param;
			log.info("get  urlString :" + urlString);
		}
		...
		//urlConnection.setRequestProperty("contentType", this.defaultContentEncoding);
        ...
        //内部定义
		if (method.equalsIgnoreCase("POST") && parameters != null && this.contentType != null && this.contentType.startsWith("multipart/form-data")) {
			StringBuffer param = new StringBuffer();
			for (String key : parameters.keySet()) {
            ...
            param.append("----abc--");
			log.info("Post  urlString :" + urlString  +"?"+ param );
