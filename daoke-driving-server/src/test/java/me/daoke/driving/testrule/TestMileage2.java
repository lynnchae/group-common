 ...
 * Time: 14:03
 */
public class TestMileage2 extends BaseTest {


    Logger log = LoggerFactory.getLogger(TestMileage2.class);
    ...
    public void calRoll() throws InterruptedException {
        //查询开关机总行数据
        totalCount = this.jdbcTemplateDateCenter.queryForInt("select count(*) from daoke_AccountID_Date_bak_20150528_01 where accountID  = 'kxl1QuHKCD' and LENGTH(accountID) >0");
...
//                public void run() {
        ...
        List<Map<String, Object>> listPowerA = jdbcTemplateDateCenter.queryForList("select accountID from daoke_AccountID_Date_bak_20150528_01 where LENGTH(accountID) >0  and accountID ='kxl1QuHKCD' limit ?,?"
